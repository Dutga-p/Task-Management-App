...
export const DraggableTaskCard = ({ task, index, onTaskClick }: DraggableTaskCardProps) => {
      ...
      {(provided, snapshot) => (
        <div
          ...
          className={`bg-white dark:bg-slate-800 rounded-lg p-4 shadow-sm border-l-4 ${getPriorityColor(
            task.priority
          )} border-t border-r border-b border-slate-200 dark:border-slate-700 cursor-pointer group ${
            snapshot.isDragging
